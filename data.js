...
const DATA = {
  categories: [
    { id:'getting-started', title:'User Onboarding', icon:'rocket', color:'var(--cat-1)', desc:'The moment someone decides to try Ethereum, a clock starts. Within five minutes, they will either complete their first action or leave permanently. These are the walls between curiosity and that first transaction.', problems:[
    ...
    { id:'transaction-clarity', title:'Transaction Clarity', icon:'eye', color:'var(--cat-2)', desc:'Every wallet transaction is a trust decision. Users are asked to approve things they can\'t read, in formats that obscure risk. These are the gaps between what the user sees and what actually happens.', problems:[
    ...
    { id:'cross-chain', title:'Cross-chain & Networks', icon:'chain', color:'var(--cat-3)', desc:'Ethereum now spans dozens of networks. Users see fragmented balances, manual chain switching, and bridges that feel like sending money into a void. The protocol solved scaling. The UX hasn\'t caught up.', problems:[
    ...
    { id:'safety', title:'Safety & Security', icon:'shield', color:'var(--cat-4)', desc:'One bad experience, one lost transaction, and a user is gone for good. Solutions should empower user agency with transparent, controllable defenses rather than opaque restrictions users never opted into.', problems:[
    ...
    { id:'mobile', title:'Mobile & Connectivity', icon:'phone', color:'var(--cat-5)', desc:'More than half of web traffic is mobile. Yet connecting a wallet from a phone browser remains one of the most broken flows in the ecosystem.', problems:[
    ...
    { id:'language', title:'Language & Accessibility', icon:'globe', color:'var(--cat-6)', desc:'Over 75% of cryptocurrency users are non-native English speakers. Most dapps are English-only, jargon-heavy, and fail basic accessibility standards. This is the largest unaddressed audience in the ecosystem.', problems:[
    ...
    { id:'protocol', title:'Protocol Design', icon:'gear', color:'var(--cat-7)', desc:'Some UX problems can\'t be solved at the wallet layer. They originate in protocol design decisions that ripple outward as confusion, friction, and risk for end users.', problems:[
    ...
    { id:'daily-ops', title:'Daily Operations', icon:'grid', color:'var(--cat-8)', desc:'The tasks people do every day: sending tokens, checking balances, managing gas. These should be the most polished flows in the ecosystem. They are often the most frustrating.', problems:[
